...
<ol class="steps">
  ...
  <li><b>Connect a model.</b> Paste a free Mistral key, or point Pellaeon at Ollama on your own machine. <a href="install.html#free-to-start">Get a free key</a> · <a href="install.html#choosing-an-ai">Local or cloud?</a></li>
...
<h2>Free to start</h2>
<p>Pellaeon needs a model to think with. The one we would start with today is <b>Mistral</b>: the free key takes two minutes, needs no credit card, and allows around 190 requests a minute — enough that you never wait on it. It handled every request in our test set, and it can look at the 3D view and fix a crowded figure.</p>
<ol class="steps">
  <li><b>Sign up.</b> At <a href="https://console.mistral.ai/api-keys" rel="noopener">console.mistral.ai/api-keys</a>. No credit card.</li>
  <li><b>Create a key.</b> Copy it to the clipboard.</li>
  <li><b>Paste it into Pellaeon.</b> Gear icon, choose Mistral, paste, then Test connection.</li>
</ol>
<p class="small">Google Gemini's free tier works just as well at a slower 15 requests a minute. Both are evaluation tiers whose providers may train on what you send, so for unpublished structures run a local model with Ollama, where nothing leaves your computer. <a href="install.html#what-the-free-tiers-really-allow">What each free tier allows</a></p>
...
<div class="grid">
  ...
  <div class="card"><h3>Local or cloud AI</h3><p>A free Mistral or Gemini key, Ollama on your own machine (free, private, nothing leaves it), Claude, OpenAI, or any OpenAI-compatible server. <a href="install.html#choosing-a-model">Which one?</a></p></div>
