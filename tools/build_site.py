...
<div class="grid">
  ...
  <div class="card"><h3>Local or cloud AI</h3><p>Ollama on your own machine (free, private; Gemma 4 can even look at the screen), Google Gemini's free tier, Claude, OpenAI, or any OpenAI-compatible server. <a href="install.html#choosing-a-model">Which one?</a></p></div>
