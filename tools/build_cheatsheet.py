...
RECIPES = [
    {"request": "open the af model for the gene adrb2", "commands": ["open alphafold:P07550"],
     "note": "P07550 came from resolve_protein('ADRB2'); never guess accessions."},
    {"request": "open the alphafold model for the gene adrb2, after that color it in white but color amino acid 159 in blue",
     "commands": ["open alphafold:P07550", "color #1 white", "show #1:159 atoms", "style #1:159 stick", "color #1:159 blue", "view #1:159"]},
    {"request": "i want to see the human protein coded by the gene adrb1", "commands": ["open alphafold:P07550"],
    ...
    {"request": "close it, instead open adra2a, and make it look publiction ready",
     "commands": ["close #1", "open alphafold:P08913", "preset \"overall look\" \"publication 1\"", "lighting soft", "graphics silhouettes true", "set bgColor white", "view"]},
    ...
    {"request": "show the transmembrane helices of ADRB2 in orange",
     "commands": ["color #1 white", "color #1:47-73,84-107,124-147,169-192,222-247,271-294,305-329 orange target ac"],
     "note": "ranges from protein_features(accession, ['Transmembrane']) after resolve_protein('ADRB2')."},
